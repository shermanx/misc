...
export PS1="\[\033[0;31m\]YOUR_SERVER_ID(`dig TXT +short o-o.myaddr.l.google.com @ns1.google.com | awk -F'"' '{ print $2}'`)-\[\033[0;32m\]\[\e]0;\u@\h: \w\a\]${debian_chroot:+($debian_chroot)}\u@\h:\w\$"
echo "***"
sensors
echo "***"
vnstat -d
